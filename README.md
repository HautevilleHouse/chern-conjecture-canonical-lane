...
Canonical Lane research workspace for a flagship problem in affine differential geometry:
proving affine-completeness and Euler-characteristic persistence in the declared admissible class through an admissible affine-connection closure architecture.

## Main Manuscript

- [paper/CHERN_CONJECTURE_PREPRINT.md](paper/CHERN_CONJECTURE_PREPRINT.md)
- [paper/CANONICAL_ROUTING_INDEX.md](paper/CANONICAL_ROUTING_INDEX.md)

## Structure

- `paper/`
  - `CHERN_CONJECTURE_PREPRINT.md`
...
1. Theorem chain first: read `paper/CHERN_CONJECTURE_PREPRINT.md`.
...
Current CHN runner policy:

- `repro/run_repro.sh` extracts, promotes, runs `scripts/chn_closure_guard.py`, updates `repro/repro_manifest.json`, and enforces `fully_extracted` release-gate mode.
...
3. artifact key consumed by `scripts/chn_closure_guard.py`.
...
- Manuscript target: [paper/CHERN_CONJECTURE_PREPRINT.md](paper/CHERN_CONJECTURE_PREPRINT.md)
