...
6. Scalar closure: `CHN_G1`, `CHN_G2`, `CHN_G3`, `CHN_G4`, `CHN_G5`, `CHN_G6`, `CHN_GM` all `PASS`.

Primary files:

- `paper/CHERN_CONJECTURE_PREPRINT.md`
- `notes/EG1_public.md`
- `notes/EG2_public.md`
- `notes/EG3_public.md`
- `notes/EG4_public.md`
...
| `CHN_G6` | `eps_coh` | strict coherence / identification closure |
| `CHN_GM` | derived | final strict margin |
