#!/usr/bin/env python3
"""Canonical-lane closure guard for the Chern conjecture workspace."""
...
def compute_report(data: dict[str, Any], sigma_star: float | None, strict_coh_zero: bool) -> dict[str, Any]:
    ...
    native_names = ['CHN_G1', 'CHN_G2', 'CHN_G3', 'CHN_G4', 'CHN_G5']
    gates = {name: ('PASS' if passed else 'FAIL') for name, passed in zip(native_names, gate_pass)}
    gates['CHN_G6'] = 'PASS' if coh_pass else 'FAIL'
    gates['CHN_GM'] = 'PASS' if gm_pass else 'FAIL'
    blockers = {}
